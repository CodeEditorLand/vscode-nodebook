...
declare module "vscode" {
	 ...
	 */
	export type DebugProtocolVariableContainer = {};
	 ...
	 */
	export type DebugProtocolVariable = {};
	...
	export interface OnTypeRenameRangeProvider {
		...
		provideOnTypeRenameRanges(
			...
			position: Position,
			token: CancellationToken,
		): ProviderResult<OnTypeRenameRanges>;
	}
	...
	namespace languages {
		 ...
		 * @return A [disposable](#Disposable) that unregisters this provider when being disposed.
		 */
		export function registerOnTypeRenameRangeProvider(
			selector: DocumentSelector,
			provider: OnTypeRenameRangeProvider,
		): Disposable;
	}
